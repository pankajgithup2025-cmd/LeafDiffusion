...
# ============================================
# 📦 STEP 3: CLONE STYLEGAN3 REPOSITORY
# ============================================
# %cd /content
!git clone https://github.com/NVlabs/stylegan3.git
# %cd stylegan3

# CBAM_UPDATED ARCHITECTURE
...
!python /content/stylegan3/dataset_tool.py \
  --source=/content/drive/MyDrive/INSECTDAMAGEWEBBER \
  --dest=/content/drive/MyDrive/INSECTDAMAGEWEBBER.zip \
  --resolution=512x512

!python /content/stylegan3/train.py \
  --outdir=/content/drive/MyDrive/stylegan3-training \
  --data=/content/drive/MyDrive/INSECTDAMAGEWEBBER.zip \
  --resume=/content/drive/MyDrive/stylegan3-training/00010-stylegan3-t-INSECTDAMAGEWEBBER-gpus1-batch8-gamma6.6/network-snapshot-000500.pkl \
  --gpus=1 \
  --batch=8 \
  --gamma=6.6 \
  --snap=10 \
...
# # ================================================================
# # ✅ CBAM-Compatible Image Generator for StyleGAN3
# # ================================================================
# import os
# import torch
# import numpy as np
...
#     print("✅ Using CBAM-enhanced Generator for image generation.")
# except ImportError:
#     GeneratorCBAM = None
#     print("⚠️ CBAM generator not found, using default Generator.")
# 
# # -------------------------------------------------------------
...
#         print(f"✅ Generated: seed{seed:04d}.png")
# 
# # -------------------------------------------------------------
# # Entry point
# # -------------------------------------------------------------
...
!python /content/stylegan3/gen_images.py \
  --outdir=/content/drive/MyDrive/stylegan3-training/generated_INSECTDAMAGEWEBBER\
  --seeds=0-4999 \
  --trunc=0.3 \
  --network=/content/drive/MyDrive/stylegan3-training/00012-stylegan3-t-INSECTDAMAGEWEBBER-gpus1-batch8-gamma6.6/network-snapshot-001000.pkl

!zip -r /content/drive/MyDrive/stylegan3-training/generated_INSECTDAMAGEWEBBER.zip /content/drive/MyDrive/stylegan3-training/generated_INSECTDAMAGEWEBBER

!pip install sympy==1.12 --quiet

# ============================================================
# 🔍 IMAGE QUALITY METRICS FOR INSECTDAMAGEWEBBER CLASS (512x512)
...
# 📂 PATHS (UPDATE BELOW)
# ------------------------------------------------------------
real_base_dir = "/content/drive/MyDrive/INSECTDAMAGEWEBBER"
fake_base_dir = "/content/drive/MyDrive/stylegan3-training/generated_INSECTDAMAGEWEBBER"

# ------------------------------------------------------------
# ⚠️ Dummy Inception Score (Replace later if needed)
# ------------------------------------------------------------
def inception_score(images, splits=10):
    return 2.5, 0.1  # placeholder

# ------------------------------------------------------------
# 📏 METRIC COMPARISON FUNCTION (NO LPIPS)
# ------------------------------------------------------------
...
print(f"🟢 Found {len(real_imgs)} paired 512x512 INSECTDAMAGEWEBBER images for comparison.")
...
# 📊 PRINT RESULTS
# ------------------------------------------------------------
print("\n📊 RESULTS FOR INSECTDAMAGEWEBBERCLASS (512x512)")
print("=" * 80)
print(f"{'Class':<15} {'FID':<6} {'IS':<6} {'IS_std':<7} "
      f"{'CFID':<6} {'Prec':<6} {'Recall':<7} {'SSIM':<6} "
      f"{'PSNR':<6} {'MSE':<8}")

print(f"{'INSECTDAMAGEWEBBER ':<15} {FID:<6.2f} {IS_val:<6.2f} {IS_std:<7.2f} "
      f"{CFID:<6.2f} {PREC:<6.2f} {RECALL:<7.2f} {SSIM_val:<6.2f} "
      f"{PSNR_val:<6.2f} {MSE_val:<8.2f}")

# ============================================
# 🖼️ IMAGE GENERATION + AUTO ZIP (CBAM StyleGAN3)
# ============================================

# ✅ Step 1: Generate images using trained model
!python /content/stylegan3/gen_images.py \
...
# ✅ Step 2: Create ZIP of generated images for download
!zip -r /content/generated_CBAM.zip /content/generated_CBAM > /dev/null

# ✅ Step 3: Copy ZIP to Google Drive for permanent storage
...
print("📁 ZIP saved at: /content/drive/MyDrive/stylegan3-training/generated_CBAM.zip")
...
!python /content/stylegan3/gen_images.py \
  ...
  --seeds=501-1000 \
  --trunc=1 \
  --network=/content/drive/MyDrive/stylegan3-training/00012-stylegan3-t-INSECTDAMAGEWEBBERgpus1-batch8-gamma6.6/network-snapshot-001000.pkl
...
--seed=42 \
--kimg=2500 \
--resume=/content/drive/MyDrive/stylegan3-training/00012-stylegan3-t-INSECTDAMAGEWEBBER-gpus1-batch8-gamma6.6/network-snapshot-001000.pkl