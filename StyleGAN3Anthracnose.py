# -*- coding: utf-8 -*-
"""NewStyle3Anthracnose.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1zm6VVgWUMh1C0CTFs2_ySuTZ1lFF62Dd
"""
...
!python /content/stylegan3/dataset_tool.py \
  --source=/content/drive/MyDrive/ANTHRECNOSE \
  --dest=/content/drive/MyDrive/ANTHRECNOSE.zip \
  --resolution=512x512
...
!python /content/stylegan3/train.py \
  --outdir=/content/drive/MyDrive/stylegan3-training \
  --data=/content/drive/MyDrive/ANTHRECNOSE.zip \
  --resume=/content/drive/MyDrive/stylegan3-training/00010-stylegan3-t-ANTHRECNOSE-gpus1-batch8-gamma6.6/network-snapshot-000500.pkl \
  --gpus=1 \
  --batch=8 \
  --gamma=6.6 \
  --snap=10 \
...
!zip -r /content/drive/MyDrive/stylegan3-training/generated_ANTHRA.zip /content/drive/MyDrive/stylegan3-training/generated_ANTHRA

!pip install sympy==1.12 --quiet

# ============================================================
# 🔍 IMAGE QUALITY METRICS FOR INSECTDAMAGEWEBBER CLASS (512x512)
# LPIPS REMOVED – COLAB-FRIENDLY
# ============================================================
...
# 📂 PATHS (UPDATE BELOW)
# ------------------------------------------------------------
real_base_dir = "/content/drive/MyDrive/ANTHRECNOSE"
fake_base_dir = "/content/drive/MyDrive/stylegan3-training/generated_ANTHRA"
...
# 📊 PRINT RESULTS
# ------------------------------------------------------------
print("\n📊 RESULTS FOR ANTHRECNOSE CLASS (512x512)")
print("=" * 80)
print(f"{'Class':<15} {'FID':<6} {'IS':<6} {'IS_std':<7} "
      f"{'CFID':<6} {'Prec':<6} {'Recall':<7} {'SSIM':<6} "
      f"{'PSNR':<6} {'MSE':<8}")

print(f"{'ANTHRECNOSE':<15} {FID:<6.2f} {IS_val:<6.2f} {IS_std:<7.2f} "
