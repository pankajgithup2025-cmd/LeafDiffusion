...
!python /content/stylegan3/dataset_tool.py \
  --source=/content/drive/MyDrive/LEAFBLIGHT \
  --dest=/content/drive/MyDrive/LEAFBLIGHT.zip \
  --resolution=512x512

!python /content/stylegan3/train.py \
  --outdir=/content/drive/MyDrive/stylegan3-training \
  --data=/content/drive/MyDrive/LEAFBLIGHT.zip \
  --resume=/content/drive/MyDrive/stylegan3-training/00010-stylegan3-t-LEAFBLIGHT-gpus1-batch8-gamma6.6/network-snapshot-000500.pkl \
  --gpus=1 \
  --batch=8 \
  --gamma=6.6 \
  --snap=10 \
...
!python /content/stylegan3/gen_images.py \
  --outdir=/content/drive/MyDrive/stylegan3-training/generated_LEAFBLIGHT\
  --seeds=0-4999 \
  --trunc=0.3 \
  --network=/content/drive/MyDrive/stylegan3-training/00012-stylegan3-t-LEAFBLIGHT-gpus1-batch8-gamma6.6/network-snapshot-001000.pkl

!zip -r /content/drive/MyDrive/stylegan3-training/generated_LEAFBLIGHT.zip /content/drive/MyDrive/stylegan3-training/generated_LEAFBLIGHT

!pip install sympy==1.12 --quiet

# ============================================================
# 🔍 IMAGE QUALITY METRICS FOR LEAFBLIGHT CLASS (512x512)
...
# 📂 PATHS (UPDATE BELOW)
# ------------------------------------------------------------
real_base_dir = "/content/drive/MyDrive/LEAFBLIGHT"
fake_base_dir = "/content/drive/MyDrive/stylegan3-training/generated_LEAFBLIGHT"
...
print(f"🟢 Found {len(real_imgs)} paired 512x512 LEAFBLIGHT images for comparison.")
...
# 📊 PRINT RESULTS
# ------------------------------------------------------------
print("\n📊 RESULTS FOR LEAFBLIGHT CLASS (512x512)")
print("=" * 80)
print(f"{'Class':<15} {'FID':<6} {'IS':<6} {'IS_std':<7} "
      f"{'CFID':<6} {'Prec':<6} {'Recall':<7} {'SSIM':<6} "
      f"{'PSNR':<6} {'MSE':<8}")

print(f"{'LEAFBLIGHT ':<15} {FID:<6.2f} {IS_val:<6.2f} {IS_std:<7.2f} "
...
--seed=42 \
--kimg=2500 \
--resume=/content/drive/MyDrive/stylegan3-training/00012-stylegan3-t-LEAFBLIGHT-gpus1-batch8-gamma6.6/network-snapshot-001000.pkl